...
import { cadastrar } from '../service/UsuarioService';
...
export default function AssetExample() {
    ...
    cadastrar(userName, userEmail, userPassword);
  ...
  return (
    <View style={styles.container}>
      <View style = {styles.content}>
        ...
        <Input label="Nome completo"  value={username} onChange={(e) => setUsername(e.target.value)}/>
        ...
        <Input label="Senha" secureTextEntry={true} value={userpassword} onChange={(e) => setUserpassword(e.target.value)}/>
