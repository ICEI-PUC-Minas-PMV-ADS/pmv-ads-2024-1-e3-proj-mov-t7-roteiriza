...
| 05 | Editar uma viagem | RF-003 | 1. Logar-se no app<br> 2. Na página inicial, clicar em "Atualizar Viagem"<br> 3. Preencher o formulário de novamente;<br>4. Clicar em salvar; | O resultado esperado deste teste é o usuário  conseguir editar uma viagem corretamente. |
